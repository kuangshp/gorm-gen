...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.Category = field.NewInt64(tableName, "category")
	_message.TargetID = field.NewInt64(tableName, "target_id")
	_message.Media = field.NewInt64(tableName, "media")
	_message.Content = field.NewString(tableName, "content")
	_message.Pic = field.NewString(tableName, "pic")
	_message.URL = field.NewString(tableName, "url")
	_message.Remark = field.NewString(tableName, "remark")
...
type message struct {
	...
	ALL       field.Asterisk
	ID        field.Int64  // 主键id
	UserID    field.Int64  // 谁发的消息,关联到user表id
	Category  field.Int64  // 消息类型,10表示私聊,11表示群聊,,0是单聊
	TargetID  field.Int64  // 如果是好友就关联到user表的id,如果是群聊就关联到community表id
	Media     field.Int64  // 消息按照什么样式展示
	Content   field.String // 消息内容体
	Pic       field.String // 图片预览地址
	URL       field.String // 服务的url
...
func (m *message) updateTableName(table string) *message {
	...
	m.Category = field.NewInt64(table, "category")
	m.TargetID = field.NewInt64(table, "target_id")
	m.Media = field.NewInt64(table, "media")
