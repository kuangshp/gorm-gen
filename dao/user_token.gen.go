...
func newUserToken(db *gorm.DB, opts ...gen.DOOption) userToken {
	...
	_userToken.ExpireTime = field.NewField(tableName, "expire_time")
	_userToken.CreatedAt = field.NewField(tableName, "created_at")
	_userToken.UpdatedAt = field.NewField(tableName, "updated_at")
...
type userToken struct {
	...
	ALL        field.Asterisk
	ID         field.Int64  // 主键id
	UserID     field.Int64  // 关联到用户表id
	Token      field.String // token
	ExpireTime field.Field  // 失效时间
...
func (u *userToken) updateTableName(table string) *userToken {
	...
	u.ExpireTime = field.NewField(table, "expire_time")
